...
<head>
    <meta charset="UTF-8">
    <title>Edit Genre • Admin Panel</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <!-- Header Admin (sama persis kayak create produk, create kategori, dll) -->
        ...
        <div class="bg-white shadow-2xl rounded-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-700 px-10 py-10">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-5xl font-bold text-white">Edit Genre Buku</h2>
                        <p class="text-indigo-100 mt-3 text-lg">Ubah nama dan deskripsi</p>
                    </div>
            ...
            <!-- Form Edit -->
            <div class="p-10">
                <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="4"
                                      class="w-full px-6 py-4 border-2 border-gray-300 rounded-xl focus:border-indigo-500 focus:outline-none text-lg @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="text-center pt-10">
                        <button type="submit" 
                                class="px-16 py-6 bg-gradient-to-r from-green-600 to-emerald-700 text-white font-bold text-2xl rounded-full hover:shadow-2xl transform hover:-translate-y-3 transition duration-300 shadow-2xl">
                            Simpan Perubahan
                        </button>
                    </div>
                </form>
